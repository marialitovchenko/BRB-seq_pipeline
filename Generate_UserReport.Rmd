...
### R1 
```{r perBaseTrimQC_R1, fig.height = 6, fig.width = 8, fig.align = "left"}
plotPerBaseQuality_plotly(perBaseQCtrim_R1, 'Per base quality for R1')
```
...
### R1 
```{r adapterTrimQC_R1, fig.height = 6, fig.width = 8, fig.align = "left"}
plotAdapterContent_plotly(adaptersTrim_R1, 'Adapter contamination in R2')
```
